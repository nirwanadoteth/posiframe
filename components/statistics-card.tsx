    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
        <Tooltip>
          <TooltipTrigger
            render={
              <Card className="glass-card relative overflow-hidden border-orange-500/20 bg-orange-500/5 transition-colors hover:bg-orange-500/10">
          ...
          />
          <TooltipContent>
            <p>Consecutive days you've used PosiFrame</p>
          </TooltipContent>
        </Tooltip>

        <Tooltip>
          <TooltipTrigger>
            <Card className="glass-card border-blue-500/20 bg-blue-500/5 transition-colors hover:bg-blue-500/10">
              <CardContent className="flex flex-col items-center justify-center p-4 text-center">
          ...
          <TooltipContent>
            <p>Total negative messages reframed</p>
          </TooltipContent>
        </Tooltip>
      </div>
      ...
      {canShare && (
        <Tooltip>
          ...
          <TooltipContent>
            <p>Share your stats on Farcaster</p>
          </TooltipContent>
        </Tooltip>
      )}
    </div>
